...
public class OrderedVector<E> implements ContenidorAfitat<E>{
	private static final long serialVersionUID = -785664338308519544L;
    ...
    public void rshift(int i) {
        // desplazamiento de todos los elements una posición
        int p = len-1;
        while (p >= i) {
            data[p+1] = data[p];
            p--;
    ...
    public void update(E vIn) {
        ...
        // desplazamiento hacia la derecha de todos los elements
        rshift(i);
	...
	public Iterador<E> elements() {
        return (Iterador<E>)new IteradorVectorImpl<E>(data, len, 0);
    }
